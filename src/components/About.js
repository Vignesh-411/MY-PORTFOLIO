        ...
        <div className="About-Content">
          <div className="About-Container">
            <div className="About-Heading">
              <div className="Head2">
                <h1>
                  Key Technologies I Rely On for High-Quality Web Development
                </h1>
              </div>
            </div>
              ...
              <div classname="set1-container">
                <div className="html-container">
                  <div className="html1">
                    ...
                    />
                    <p>
                      lorem ipsum dolor sit amet, consect id elit, sed diam
                      nonum et justo ut aliquet et justo e shallow et
                      aliquetlorem ipsum dolor sit amet, consect id elit, sed
                      diam nonum et justo ut aliquet et justo e shallow et
                      aliquetlorem ipsum dolor sit amet, consect id elit, sed
                      diam nonum et justo ut aliquet et justo e shallow et
                      aliquetlorem ipsum dolor sit amet, consect id elit, sed
                      diam nonum et justo ut aliquet et justo e shallow et
